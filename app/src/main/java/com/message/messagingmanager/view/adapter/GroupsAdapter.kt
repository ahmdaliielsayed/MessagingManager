...
class GroupsAdapter(private val groupsList: ArrayList<Any>, private var groupsActivity: GroupsActivity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when(viewType) {
            ROW_ITEM_VIEW_TYPE -> {
                itemView = LayoutInflater.from(parent.context).inflate(R.layout.row_select_group, parent, false)
...
//                }
                ...
                val adView = groupsList[position] as AdView
